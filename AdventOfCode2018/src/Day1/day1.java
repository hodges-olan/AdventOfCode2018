    ...
    public static void main(String[] args) {
        ...
        while(!partTwoAnswerFound) {
            for(Integer entry: input) {
                total += entry;
                if(uniqueEntries.contains(total) && !partTwoAnswerFound) {
                    partTwoAnswerFound = true;
                    System.out.println("Part Two Answer: " + total.toString());
                }
                uniqueEntries.add(total);
            }
            if(!partOneAnswerFound) {
                System.out.println("Part One Answer: " + total.toString());
                partOneAnswerFound = true;
            }
        }
    }
